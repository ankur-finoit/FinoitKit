...
import com.finoit.net.HttpConnectionMonitor;

/**
 * This Class has listed all the basic methods of android application
 * @author Ankur Parashar
 *
 */
public class FinoitKit {
    ...
    public static int getInteger(int resource) {
        return getResources().getInteger(resource);
    }
    
    public static float getDimension(int resource) {
    ...
    public static boolean isJellyBean(){
         // Can use static final constants like JELLY_BEAN, declared in later versions
        // of the OS since they are inlined at compile time. This is guaranteed behavior.
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN;
    }
    
    public static boolean isIceCreamSandwitch(){
         // Can use static final constants like IceCreamSandwitch, declared in later versions
        // of the OS since they are inlined at compile time. This is guaranteed behavior.
	...
	public static boolean isTablet() {
        ...
        return ( isHoneycomb() || isIceCreamSandwitch() || isJellyBean() ) 
