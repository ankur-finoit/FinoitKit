package com.finoitkit.httpimagelib;
            ...
            public LoadRequest call() {
                ...
                try {
                    	...
                    	if(data == null){
                        	...
                        	if(DEBUG) 
                        		Log.d(TAG, "cache missing " + request.getUri().toString());
                        ...
                        if(data != null) {
                            ...
                            if(DEBUG)  Log.d(TAG, "found in persistent: " + request.getUri().toString());
                        		...
                        		//we go to network
                        		if( request.getUri() == null || request.getImageView() == null )
                        				return null;
                    ...
                    if(data != null && !data.isRecycled() && request.getImageView() != null) {
                        ...
                        synchronized ( iv ) {
                        	...
                        	if ( iv!=null &&  iv.getTag() == request.getUri() ) {
                                  ...
                                  mHandler.post(new Runnable() {    
                                	  ...
                                	  public void run() {
                                         ...
                                         if ( iv.getTag() == request.getUri() && !theData.isRecycled() ) {
                                             	iv.setAnimation(null);
                                        	 	iv.setImageBitmap(theData);
                                             	iv.setVisibility(View.VISIBLE);
                                             	OnLoadResponseListener l = request.mListener;
                                             	if( l != null) l.onLoadResponse(request, theData);
                                         } 
                    ...
                    /*else if(data!=null && request.getImageView() != null){
                    	data.recycle();
                    }*/
